...
function successful(name1, face){
    ...
    var face = "https://gate-known-faces.s3.amazonaws.com/" + face 
    sessionStorage.setItem("face_url", face); 
    window.open("./webpage2_success.html","_blank");
}
...
$('.btn').click(function() {
  ...
  apigClient.virtualDoorPost({}, body, {})
      .then(function(result){
        ...
        if (valid == false){
          window.open('https://gate-visitors.s3.amazonaws.com/webpage2_deny.html');
